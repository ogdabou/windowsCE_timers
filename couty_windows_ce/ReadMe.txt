========================================================================
    APPLICATION CONSOLE&nbsp;: Vue d'ensemble du projet couty_windows_ce
========================================================================

AppWizard a cr&eacute;&eacute; cette application couty_windows_ce pour vous.

Ce fichier contient un r&eacute;sum&eacute; des &eacute;l&eacute;ments contenus dans chaque fichier qui
constitue votre application couty_windows_ce.


couty_windows_ce.vcproj
...
StdAfx.h, StdAfx.cpp
    ...
    nomm&eacute; couty_windows_ce.pch et un fichier de types pr&eacute;compil&eacute;s nomm&eacute; StdAfx.obj.
